...
| Etapa | Obsah |
|---|---|
| 1 | Auth, layout, PWA, dark/light + denný check-in (ráno/večer) + fokus + návyky |
| 2 | Tréningy (úrovne, míľniky, denné kroky) + reflexný denník |
| 3 | Týždenná reflexia (auto-súhrn) + sezóna + vízia - ladí sa na reálnych dátach z etáp 1-2 |
